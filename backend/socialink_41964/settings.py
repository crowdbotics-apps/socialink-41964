"""
Django settings for socialink_41964 project.
...
ROOT_URLCONF = 'socialink_41964.urls'
...
WSGI_APPLICATION = 'socialink_41964.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "socialink_41964 API",
    "DESCRIPTION": "API documentation for socialink_41964 App",
    "VERSION": "v1",
}
